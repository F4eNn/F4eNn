...
[![My Skills](https://skillicons.dev/icons?i=html,css,sass,react,nextjs,firebase,git,gulp,js,ts,materialui,styledcomponents,tailwind,bootstrap,redux&perline=7)](https://skillicons.dev)
